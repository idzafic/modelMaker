...
public:
	switcher(gui::plot::View& mainView) : gui::ViewSwitcher(2), graphProps(8), lineProps(6), mainGraph(mainView),
...
splitterLayout::splitterLayout(gui::plot::View& mainView) : _mainLayout(gui::SplitterLayout::Orientation::Horizontal), v(4), _graph(mainView)
{
...
void splitterLayout::refreshPicks(){
	...
	for (const gui::plot::Function& fun : funs) {
